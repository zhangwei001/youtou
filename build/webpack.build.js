...
module.exports = merge(baseWebpackConfig, {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin([
            {from:path.resolve(__dirname, config.dev.assets), to: path.resolve(__dirname, '../dist'+config.pro.assets) }
        ]),
        ...
        new HtmlWebpackPlugin({
            ...
            inject: "body",
            sVersion:sDate,
            iviewPath: envConfig.iviewPath, //view组件的路径
            assetsPath:envConfig.assets,//资源路径
